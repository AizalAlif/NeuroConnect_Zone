...
const KadMemoriHardScreen = ({ navigation }) => {
  ...
  const saveScoreToLeaderboard = async (userName, moves) => {
    try {
      ...
      await set(ref(database, `kadMemoriHardLeaderboard/${userId}`), {
    ...
    >
      <View style={styles.overlay}>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.header}>Kad Memori Hard</Text>
...
export default KadMemoriHardScreen;

...
const LeaderboardKadMemoriLevel = () => {
  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        <Text style={styles.title}>Carta Kad Memori</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            playSound();
            navigation.navigate('LeaderboardKadMemoriHard');
          }}
        >
          <View style={styles.levelContent}>
            <LottieView
...
export default LeaderboardKadMemoriLevel;

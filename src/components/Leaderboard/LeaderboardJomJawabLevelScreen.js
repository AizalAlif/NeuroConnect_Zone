...
const LeaderboardJomJawabLevel = () => {
  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        <Text style={styles.title}>Carta Jom Jawab</Text>
        ...
        >
          <View style={styles.levelContent}>
            ...
            />
            <Text style={styles.menuText}>Medium</Text>
          </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            playSound();
            navigation.navigate('LeaderboardJomJawabHard');
          }}
        >
          <View style={styles.levelContent}>
            <LottieView
            ...
            />
            <Text style={styles.menuText}>Hard</Text>
          </View>
        </TouchableOpacity>
      </View>
    </ImageBackground>
...
export default LeaderboardJomJawabLevel;

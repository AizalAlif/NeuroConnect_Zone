    ...
    >
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            playSound();
            navigation.navigate('JomJawabEasy', { level: 'Easy' });
          }}
        >
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            playSound();
            navigation.navigate('JomJawabMedium', { level: 'Medium' });
          }}
        >
          <View style={styles.levelContent}>
            <LottieView
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            playSound();
            navigation.navigate('JomJawabHard', { level: 'Hard' });
          }}
        >
          <View style={styles.levelContent}>
            <LottieView
...
export default JomJawabLevelScreen;
